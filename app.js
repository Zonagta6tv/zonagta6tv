...
// Comentarios públicos reales mediante Utterances + GitHub Issues.
const UTTERANCES_REPO="zonagta6tv/zonagta6tv";
if(!UTTERANCES_REPO.startsWith("TU_")){
  ...
  s.setAttribute("repo",UTTERANCES_REPO);s.setAttribute("issue-term","title");s.setAttribute("theme","github-dark");
