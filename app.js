...
function renderNews(filter="todos"){
  const images=[
    "assets/news-01-extended-look.svg",
    "assets/news-02-launch.svg",
    "assets/news-03-leonida.svg",
    "assets/news-04-jason-lucia.svg",
    "assets/news-05-gallery.svg",
    "assets/news-06-community.svg"
  ];
    ...
    return `<article class="card news-card" data-category="${esc(n[5])}">
      <div class="art">
        <img src="${src}" alt="${esc(n[2])}" loading="lazy" decoding="async"
             onerror="this.onerror=null;this.src='assets/vice-neon.svg';this.classList.add('img-fallback')">
